...
Legibility obviously depends on context of [time and place](http://socks-studio.com/2014/03/02/the-three-mawangdui-maps-early-chinese-cartography/): how much do you anticipate that your audience knows and how are they accustomed to reading maps and visuals? (Not to mention how they percieve beauty!)

A general rule is to keep information in the map to a *minimum*: only show exactly what you need to say. At the most basic, this means (a) remove unecessary elements and (b) make the background a boring color  - in mapper-speak, make sure you have a visual heirarchy that puts your main story at the top. 
